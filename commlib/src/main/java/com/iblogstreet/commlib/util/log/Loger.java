package com.iblogstreet.commlib.util.log;

import com.iblogstreet.commlib.util.log.config.LogConfig;
import com.iblogstreet.commlib.util.log.config.LogDefaultConfig;
import com.iblogstreet.commlib.util.log.tree.SoulsTree;
import com.iblogstreet.commlib.util.log.tree.Tree;
...
public class Loger {
    ...
    private static boolean isAllowLog() {
        return LogDefaultConfig.getInstance().isEnable();
    }
